...
const CardList = ({ products, display, titleSlot, captionSlot, actionSlot, contentSlot }: CardListProps) => {
    const navigate = useNavigate();

    const handleCartClick = useCallback((id: ProductResponseShort['documentId']) => {
